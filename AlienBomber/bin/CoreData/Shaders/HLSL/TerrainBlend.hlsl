...
#else
sampler2D sWeightMap0
: register(s0);
sampler2D sDetailMap1
: register(s1);
sampler2D sDetailMap2
: register(s2);
sampler2D sDetailMap3
: register(s3);
#endif
...
#else
out float3
oVertexLight : TEXCOORD4,
out float4
oScreenPos : TEXCOORD5,
#endif
